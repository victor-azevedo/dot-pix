...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotPix.Models.Payments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DotPix.Models.PixKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DotPix.Models.Payments", b =>
                {
                    b.HasOne("DotPix.Models.PaymentProviderAccount", "AccountOrigin")
                        .WithMany()
                        .HasForeignKey("AccountOriginId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DotPix.Models.PixKey", "PixKeyDestiny")
                        .WithMany()
            ...
            modelBuilder.Entity("DotPix.Models.PixKey", b =>
                {
                    b.HasOne("DotPix.Models.PaymentProviderAccount", "PaymentProviderAccount")
                        .WithMany("PixKey")
